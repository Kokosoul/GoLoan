...
router.put(
  ...
  [
    ...
    [
      ...
      check("description", "Description is required")
        .not()
        .isEmpty(),
      check("from", "Loan start date is required")
        .not()
        .isEmpty(),
      check("to", "Loan end date is required")
        .not()
        .isEmpty()
    ]
  ],
  async (req, res) => {
    ...
    const { title, description, relationship, accountReceivable, accountPayable, interestRate, totalReceived, totalPayed, from, to } = req.body;
